<?php 
    ...
    $date_vente2 = date('Y-m-d');
        ...
        $reqLister = "SELECT * FROM chauffeur WHERE date_vente = :dateVente ORDER BY id DESC";
    ...
    if(isset($_POST['code_barre'])){
        ...
        if($codeBar == null){
            header("Location: livraisonChauffeur.php?error= Barre code n'existe pas ⛔"); 
        }else{
             $qnt = $qnt_restant;
             $qnt = $qnt_restant - 1;
             ...
             if($stateUpdate->execute()){
                 ...
                 $reqVente = $bd->prepare("INSERT INTO chauffeur VALUES(null, :code_barre, :categorie, :texture, :pouces, :date__, :date_vente)");
             ...
             header("Location: livraisonChauffeur.php?msg= la vente est effectuée ✔ ");
         }
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div> <h1>Livraison Chauffeur</h1> </div>
            <div class="col-12 content">
                <form action="./livraisonChauffeur.php" method="POST">
                    <div class="row">
                        <div class="col"></div>
                        <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <table class="step table table-bordered table-sm table-striped">
                            ...
                            <tbody>
                            <?php foreach($allRow as $rowSelect):?>
                            <tr>
